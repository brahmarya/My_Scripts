...
write.table(score,file = "E:/Academics/obj2-29March2019/Results/DynaSeqPair/predscore.tsv", sep = "\t");
...
write.table(err, file = "E:/Academics/obj2-29March2019/Results/DynaSeqPair/err.tsv", sep = "\t")
