...
write.table(mut_mat, file = "/storage/Collab/Mohit/Results/Point_mutations.tsv", sep = "\t", quote = FALSE)
write.table(indel_mat, file = "/storage/Collab/Mohit/Results/Indel_mutations.tsv", sep = "\t", quote = FALSE)



# Plots -------------------------------------------------------------------

barplot(mut_mat, col = rainbow(28), xlab = "Mutations", ylab = "Mutation Frequency")

barplot(t(indel_mat), beside = T, col = c("red","blue"), xlab = "Clinical Variant", ylab = "Indel Frequncy", cex.names = 0.67)
